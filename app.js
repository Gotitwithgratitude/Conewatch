...
function openDriveTour(){
  ...
  tourMap=new maplibregl.Map({container:"driveMap",
    ...
    center:co[0],zoom:17.2,pitch:78,bearing:_brg(co[0],co[1]),maxPitch:85,attributionControl:true,interactive:true});
  tourMap.on("load",()=>{
...
function _tourRender(){
  ...
  tourMap.jumpTo({center:pos,bearing:st.curBrg,pitch:78,zoom:17.2});
