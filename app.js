...
function _tourRender(){
  ...
  const ahead=_posAt(st.co,st.cum,Math.min(st.total,d+38));  // look-ahead point down the road
  ...
  // center on the look-ahead so the car sits low on screen and the road fills the view — first-person
  tourMap.jumpTo({center:ahead,bearing:st.curBrg,pitch:85,zoom:18});
